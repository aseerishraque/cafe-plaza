...
th{
 ...
 <form id="contact-us" method="post" action="addcart.php?action=order" class="scrolly">
    <h2 align="center" class="page-header">Order Summary</h2>
 <?php 
				...
				$subtotal = 0;
			        ...
			        if (!empty($_SESSION['gcCart'])){   
						...
						<?php 
						 ...
						 <div id="placeorder">
						 	<div class="row">
						 		<label class="col-xs-4" style="font-size: 15px; text-align: center;" >Table No.</label>
						 		<div class="col-xs-3">
						 		...
						 		<div class="col-xs-4">
						 			 <button  style="height: 30px;text-align:  center; width: 140px;font-size: 15px"  type="submit" id="submit" name="submit" class="text-center btn btn-primary  btn-xs">Place Order</button> 
						 		</div>
						 	</div>
						 </div> 
					<div class="clear"></div>
