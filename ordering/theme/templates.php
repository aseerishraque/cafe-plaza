                ...
                echo $viewTitle->Title;
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">   
                             <li><a class="color_animation <?php echo (publiccurrentpage() == 'index.php') ? "navactive" : "";?>" href="<?php echo web_root ;?>index.php">Home</a></li>
                            ...
                            <i class="fa fa-user"></i> Welcome <?php echo $_SESSION['WAITER_FULLNAME']; ?></a>
                            </li> 
                            <li><a class="color_animation " href="<?php echo web_root; ?>logout.php">| Log Out <i class="fa fa-sign-out"></i></a></li> 
                            <!-- <li class="dropdown">
