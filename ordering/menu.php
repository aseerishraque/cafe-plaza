...
?> 
                             <h2 align="center" class="page-header">Menu Lists</h2> 

                                <?php echo check_message(); ?>  
                            <ul id="filter-list" class="clearfix">
                                <li><a style="text-decoration: none;" class="filter <?php echo (!isset($_GET['category']) || $_GET['category']=='ALL') ? 'navactive' : '' ?>"  href="<?php echo web_root ?>index.php?view=menu&category=ALL&rem=<?php echo $remarks ?>">ALL</a></li>
